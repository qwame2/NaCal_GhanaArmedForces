    ...
    <div class="sync-card">
        ...
        <div class="sync-body">
            ...
            <div style="background:#fef2f2; border:1px solid #fecaca; border-radius:12px; padding:12px 14px; margin-bottom:1.25rem; display:flex; gap:8px; align-items:flex-start;">
                ...
                <span style="font-size:0.75rem; color:#991b1b; font-weight:600;">{{ session('error') }}</span>
            </div>
            @endif
            ...
            <form action="{{ route('password.update.otp') }}" method="POST">
                ...
                <div class="field-block">
                    <div class="field-label">
                        <label>Security OTP Code</label>
                        <span class="req-badge">FROM ADMIN</span>
                    </div>
                    <div class="field-input">
                        <div class="field-icon"><i data-lucide="hash"></i></div>
                        <input type="text" name="otp" placeholder="Enter 6-digit code" required maxlength="10">
                    </div>
                </div>
                ...
                <div class="field-block">
                    ...
                    <div class="field-input">
                        ...
                        <input type="password" name="password" id="pass-field" placeholder="Enter new password" required minlength="8">
                ...
                <div class="field-block">
                    ...
                    <div class="field-input">
                        ...
                        <input type="password" name="password_confirmation" id="confirm-field" placeholder="Repeat password" required minlength="8">
                ...
                <button type="submit" class="sync-btn" style="background: linear-gradient(135deg, #312e81 0%, #1e1b4b 100%);">
                    <i data-lucide="refresh-cw"></i>
                    Reset and Restore Access
                </button>
            </form>
        </div>
