    ...
    <div class="page-header" style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 2rem;">
        <div>
            <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 0.5rem;">
                ...
                @else
                    <span style="background: rgba(5, 150, 105, 0.1); color: var(--primary); font-size: 0.7rem; font-weight: 800; padding: 0.25rem 0.75rem; border-radius: 9999px; text-transform: uppercase;">Batch Details</span>
                @endif
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem; margin-bottom: 2rem;">
        <div class="glass-card" style="padding: 1.5rem;">
            <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1.5rem;">
                <div style="width: 44px; height: 44px; background: rgba(5, 150, 105, 0.1); color: var(--primary); border-radius: 12px; display: flex; align-items: center; justify-content: center;">
        ...
        <div class="glass-card" style="padding: 1.5rem;">
            <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1.5rem;">
                <div style="width: 44px; height: 44px; background: rgba(5, 150, 105, 0.1); color: #059669; border-radius: 12px; display: flex; align-items: center; justify-content: center;">
            ...
            <div style="display: grid; gap: 1.25rem;">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    @if($isBatchIssuedOut)
                        <span style="color: #059669; font-weight: 800; font-size: 0.9rem; text-transform: uppercase;">Issued Out</span>
                    @else
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <span style="background: rgba(5, 150, 105, 0.1); color: #059669; padding: 0.25rem 0.75rem; border-radius: 6px; font-weight: 800; font-size: 0.8rem; text-transform: uppercase;">Verified</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <table class="activity-table" style="width: 100%; min-width: 800px; border-collapse: collapse;">
                ...
                <tbody>
                    ...
                    <tr style="border-top: 1px solid var(--border-color);">
                            ...
                            @if(!empty($item->serial_number))
                                ...
                                @if($count > 0)
                                    <div class="serial-numbers-wrapper" style="margin-top: 4px; display: inline-flex; flex-wrap: wrap; align-items: center; gap: 4px;">
                                        <div style="display: inline-flex; align-items: center; flex-wrap: wrap; gap: 4px; background: rgba(5, 150, 105, 0.08); color: #059669; font-size: 0.72rem; padding: 2px 8px; border-radius: 6px; font-weight: 800; word-break: break-word; white-space: normal; max-width: 250px;">
                        ...
                        <td style="padding: 1.25rem 1.5rem; text-align: right;">
                            <div style="display: inline-flex; align-items: center; gap: 0.5rem; color: #059669; font-weight: 600; font-size: 0.85rem;">
