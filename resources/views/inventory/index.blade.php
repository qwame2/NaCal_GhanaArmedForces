...
<div class="animate-slide-up">
    ...
    <div class="page-header" style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 2rem; flex-wrap: wrap; gap: 1rem;">
        <div>
            <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 0.5rem;">
                <span style="background: rgba(5, 150, 105, 0.1); color: #059669; font-size: 0.7rem; font-weight: 800; padding: 0.25rem 0.75rem; border-radius: 9999px; text-transform: uppercase;">Master Database</span>
        ...
        <div style="display: flex; gap: 0.75rem;">
            <button class="glass-card" style="padding: 0.75rem 1.25rem; border: none; cursor: pointer; display: flex; align-items: center; gap: 0.5rem; font-weight: 700; color: var(--text-main); transition: all 0.3s;" onmouseover="this.style.background='rgba(5, 150, 105, 0.05)'" onmouseout="this.style.background='var(--bg-card)'">
                <i data-lucide="printer" style="width: 18px;"></i> Print Ledger
            </button>
            <button class="btn-primary" style="padding: 0.75rem 1.25rem; border: none; background: var(--primary-gradient); color: white; border-radius: 12px; font-weight: 700; display: flex; align-items: center; gap: 0.5rem; cursor: pointer; box-shadow: 0 8px 20px rgba(5, 150, 105, 0.3);">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1.5rem; margin-bottom: 2rem;">
        ...
        <div class="glass-card" style="padding: 1.5rem; border-radius: 20px; display: flex; align-items: center; gap: 1.25rem; border-left: 4px solid var(--primary);">
            <div style="width: 54px; height: 54px; border-radius: 14px; background: rgba(5, 150, 105, 0.1); color: var(--primary); display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
        ...
        <div class="glass-card" style="padding: 1.5rem; border-radius: 20px; display: flex; align-items: center; gap: 1.25rem; border-left: 4px solid #059669;">
            <div style="width: 54px; height: 54px; border-radius: 14px; background: rgba(5, 150, 105, 0.1); color: #059669; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
            ...
            <table style="width: 100%; border-collapse: separate; border-spacing: 0; min-width: 900px;">
                ...
                <tbody>
                    ...
                    <tr class="inv-row" style="transition: background 0.3s;" onmouseover="this.style.background='var(--bg-main)'" onmouseout="this.style.background='transparent'">
                        ...
                        <td style="padding: 1.25rem 1.5rem; border-bottom: 1px solid var(--border-color);">
                            <span style="background: rgba(5, 150, 105, 0.1); color: var(--primary); padding: 0.3rem 0.6rem; border-radius: 8px; font-size: 0.75rem; font-weight: 700;">Ledge A (Stationary)</span>
                        </td>
                        ...
                        <td style="padding: 1.25rem 1.5rem; border-bottom: 1px solid var(--border-color);">
                            <span style="background: rgba(5, 150, 105, 0.1); color: #059669; padding: 0.3rem 0.6rem; border-radius: 8px; font-size: 0.75rem; font-weight: 800; display: inline-flex; align-items: center; gap: 4px;"><div style="width:6px; height:6px; border-radius:50%; background:#059669;"></div> IN STOCK</span>
                        </td>
                    ...
                    <tr class="inv-row" style="transition: background 0.3s;" onmouseover="this.style.background='var(--bg-main)'" onmouseout="this.style.background='transparent'">
                        ...
                        <td style="padding: 1.25rem 1.5rem; border-bottom: 1px solid var(--border-color);">
                            <span style="background: rgba(5, 150, 105, 0.1); color: #059669; padding: 0.3rem 0.6rem; border-radius: 8px; font-size: 0.75rem; font-weight: 700;">Ledge C (IT)</span>
                        </td>
                        ...
                        <td style="padding: 1.25rem 1.5rem; border-bottom: 1px solid var(--border-color);">
                            <span style="background: rgba(5, 150, 105, 0.1); color: #059669; padding: 0.3rem 0.6rem; border-radius: 8px; font-size: 0.75rem; font-weight: 800; display: inline-flex; align-items: center; gap: 4px;"><div style="width:6px; height:6px; border-radius:50%; background:#059669;"></div> LOW STOCK</span>
                        </td>
                        <td style="padding: 1.25rem 1.5rem; border-bottom: 1px solid var(--border-color); text-align: right;">
                            <button style="background: transparent; border: 1px solid var(--border-color); border-radius: 8px; padding: 0.5rem; cursor: pointer; color: var(--text-main);" data-tooltip="View Details">
                                <i data-lucide="eye" style="width: 18px;"></i>
