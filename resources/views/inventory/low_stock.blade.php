...
<div class="animate-slide-up">
    ...
    <div class="page-header" style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 2rem; flex-wrap: wrap; gap: 1rem;">
        <div>
            <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 0.5rem;">
                <span style="background: rgba(5, 150, 105, 0.1); color: #059669; font-size: 0.7rem; font-weight: 800; padding: 0.25rem 0.75rem; border-radius: 9999px; text-transform: uppercase;">Stock Monitor</span>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1.5rem; margin-bottom: 2rem;">
        <div class="glass-card" style="padding: 1.5rem; border-radius: 20px; display: flex; align-items: center; gap: 1.25rem; border-left: 4px solid #059669; background: var(--bg-card); border-top: 1px solid var(--border-color); border-right: 1px solid var(--border-color); border-bottom: 1px solid var(--border-color);">
                ...
                <tbody id="monitor-table-body">
                    @php
                        function getLedgeBadgeStyle($category) {
                            $colors = [
                                'A' => ['bg' => 'rgba(5, 150, 105, 0.1)', 'color' => 'var(--primary)'],
                                'B' => ['bg' => 'rgba(239, 68, 68, 0.1)', 'color' => '#ef4444'],
                                'C' => ['bg' => 'rgba(5, 150, 105, 0.1)', 'color' => '#059669'],
                                'D' => ['bg' => 'rgba(5, 150, 105, 0.1)', 'color' => '#059669'],
                                'E' => ['bg' => 'rgba(59, 130, 246, 0.1)', 'color' => '#059669'],
                                'G' => ['bg' => 'rgba(139, 92, 246, 0.1)', 'color' => '#047857'],
                    ...
                    @forelse($lowStockItems as $item)
                        ...
                        <tr class="monitor-row" data-search-term="{{ strtolower($item->description) }} {{ strtolower($item->category_name) }}" style="transition: background 0.3s;" onmouseover="this.style.background='var(--bg-main)'" onmouseout="this.style.background='transparent'">
                            ...
                            <td style="padding: 1.25rem 1.5rem; border-bottom: 1px solid var(--border-color); font-weight: 900; color: {{ $isOutOfStock ? '#ef4444' : '#059669' }}; font-size: 1.1rem;">
                            ...
                            <td style="padding: 1.25rem 1.5rem; border-bottom: 1px solid var(--border-color);">
                                ...
                                @else
                                    <span style="background: rgba(5, 150, 105, 0.1); color: #059669; padding: 0.3rem 0.6rem; border-radius: 8px; font-size: 0.75rem; font-weight: 800; display: inline-flex; align-items: center; gap: 6px;"><div style="width:6px; height:6px; border-radius:50%; background:#059669;"></div> LOW STOCK</span>
                                @endif
                            </td>
                    ...
                    @empty
                        <tr id="empty-state-row">
                            <td colspan="6" style="padding: 8rem 2rem; text-align: center;">
                                <div style="background: var(--bg-main); width: 100px; height: 100px; border-radius: 30px; display: flex; align-items: center; justify-content: center; margin: 0 auto 2rem auto; color: #059669; border: 1px solid var(--border-color); box-shadow: 0 15px 35px rgba(0,0,0,0.03);">
