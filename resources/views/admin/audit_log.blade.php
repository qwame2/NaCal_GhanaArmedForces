    ...
    @else
        <div style="display: flex; flex-direction: column; gap: 1.5rem;">
            @foreach($auditLog as $record)
                <div class="glass-card" style="padding: 1.5rem; border-radius: 20px; border: 1px solid rgba(5, 150, 105, 0.08); background: #ffffff; box-shadow: 0 4px 20px rgba(0,0,0,0.01); transition: all 0.3s;" onmouseover="this.style.transform='translateY(-2px)';" onmouseout="this.style.transform='translateY(0)';" id="log-card-{{ $record->id }}">
