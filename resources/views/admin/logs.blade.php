...
<div class="animate-slide-up">
    <div class="page-header" style="margin-bottom: 2rem; display: flex; justify-content: space-between; align-items: center;">
        ...
        <div style="display: flex; gap: 1rem;">
            <button type="button" onclick="confirmBulkArchive()" style="background: rgba(5, 150, 105, 0.05); border: 1px solid rgba(5, 150, 105, 0.2); padding: 0.75rem 1.5rem; border-radius: 12px; color: var(--primary); font-weight: 800; display: flex; align-items: center; gap: 0.5rem; cursor: pointer; transition: all 0.3s;" onmouseover="this.style.background='var(--primary)'; this.style.color='white'; this.style.boxShadow='0 4px 12px rgba(5, 150, 105, 0.2)'" onmouseout="this.style.background='rgba(5, 150, 105, 0.05)'; this.style.color='var(--primary)'; this.style.boxShadow='none'">
    ...
    <div class="glass-card" style="padding: 2rem; margin-bottom: 2rem; border-radius: 24px; background: #ffffff; border: 1px solid rgba(5, 150, 105, 0.1); box-shadow: 0 10px 30px rgba(0,0,0,0.02);">
        <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1.5rem;">
            <div style="width: 36px; height: 36px; border-radius: 10px; background: rgba(5, 150, 105, 0.1); color: var(--primary); display: flex; align-items: center; justify-content: center;">
        ...
        <form action="{{ route('admin.logs') }}" method="GET" style="display: flex; gap: 1.5rem; align-items: flex-end; flex-wrap: wrap;">
            ...
            <div style="display: flex; gap: 1rem; align-items: center;">
                <button type="submit" class="btn-primary" style="padding: 0.85rem 2rem; border-radius: 12px; border: none; background: var(--primary); color: white; font-weight: 800; cursor: pointer; transition: all 0.3s; box-shadow: 0 4px 12px rgba(5, 150, 105,0.2);" onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 6px 15px rgba(5, 150, 105,0.3)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 12px rgba(5, 150, 105,0.2)'">
                    ...
                    <tbody>
                        ...
                        <tr id="log-row-{{ $log->id }}" style="border-bottom: 1px solid var(--border-color); transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); cursor: default; position: relative; z-index: 1;" onmouseover="this.style.background='#f8fafc'; this.style.transform='scale(1.005)'; this.style.boxShadow='0 4px 15px rgba(0,0,0,0.03)'; this.style.zIndex='10'" onmouseout="this.style.background='transparent'; this.style.transform='scale(1)'; this.style.boxShadow='none'; this.style.zIndex='1'">
                            ...
                            <td style="padding: 1.25rem 2rem; max-width: 400px;">
                                <p style="font-size: 0.85rem; color: var(--text-main); line-height: 1.5; margin: 0;">
                                    @if(str_starts_with($log->action, 'DELEGATED_'))
                                        <span style="display: inline-flex; align-items: center; gap: 4px; background: rgba(5, 150, 105, 0.08); color: var(--primary); font-size: 0.65rem; font-weight: 900; padding: 2px 8px; border-radius: 6px; border: 1px solid rgba(5, 150, 105, 0.15); margin-right: 6px; text-transform: uppercase; letter-spacing: 0.02em;">
                            ...
                            <td style="padding: 1.25rem 2rem; text-align: right;">
                                <div style="display: flex; gap: 0.5rem; justify-content: flex-end; align-items: center;">
                                    ...
                                    @endif
                                    <button type="button" onclick="archiveLog('{{ $log->id }}')" style="background: rgba(5, 150, 105, 0.05); color: var(--primary); border: 1px solid rgba(5, 150, 105, 0.2); padding: 0.4rem 0.65rem; border-radius: 10px; font-weight: 800; cursor: pointer; transition: all 0.3s;" onmouseover="this.style.background='var(--primary)'; this.style.color='white'" onmouseout="this.style.background='rgba(5, 150, 105, 0.05)'; this.style.color='var(--primary)'" title="Archive Log">
                        ...
                        <tr>
                            <td colspan="7" style="padding: 6rem 2rem; text-align: center; color: var(--text-muted); background: #f8fafc;">
                                <div style="width: 80px; height: 80px; background: white; border-radius: 20px; display: flex; align-items: center; justify-content: center; margin: 0 auto 1.5rem auto; box-shadow: 0 10px 25px rgba(0,0,0,0.05); border: 1px solid rgba(5, 150, 105,0.1);">
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                if (row) {
                    ...
                    row.style.background = 'rgba(5, 150, 105, 0.05)';
                }
        ...
        try {
            ...
            let html = `
                <div class="detail-card" style="display: flex; align-items: center; gap: 1.25rem; margin-bottom: 2rem; background: rgba(0,0,0,0.015); border: 1px solid var(--border-color); box-shadow: none;">
                    ${userAvatar ? `<img src="${userAvatar}" style="width: 48px; height: 48px; border-radius: 14px; object-fit: cover; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">` : `<div style="width: 48px; height: 48px; border-radius: 14px; background: var(--primary); color: white; display: flex; align-items: center; justify-content: center; font-size: 1.25rem; font-weight: 900; box-shadow: 0 4px 10px rgba(5, 150, 105,0.2);">${userName.charAt(0)}</div>`}
                    <div>
            ...
            if (action === 'ADD_INVENTORY') {
                ...
                if (dataObj.items_added && Array.isArray(dataObj.items_added)) {
                    ...
                    dataObj.items_added.forEach(item => {
                        ...
                        const varColor = variance > 0 ? '#059669' : (variance < 0 ? '#ef4444' : 'inherit');
                ...
                if (dataObj.items_issued && Array.isArray(dataObj.items_issued)) {
                    ...
                    dataObj.items_issued.forEach(item => {
                        html += `<tr>
                            <td><span style="background: rgba(5, 150, 105,0.1); color: var(--primary); padding: 2px 8px; border-radius: 6px; font-weight: 700; font-size: 0.75rem;">${item.category || '-'}</span></td>
                ...
                if (dataObj.batch_changes && Object.keys(dataObj.batch_changes).length > 0) {
                    html += `
                        <div class="detail-card" style="border-color: #0ea5e9; background: rgba(5, 150, 105, 0.02);">
                ...
                if (dataObj.item_changes && Object.keys(dataObj.item_changes).length > 0) {
                    html += '<h4 style="font-size: 0.85rem; font-weight: 800; color: var(--text-muted); margin-bottom: 1rem; text-transform: uppercase; display: flex; align-items: center; gap: 8px;"><i data-lucide="edit-3" style="width: 14px; color: #059669;"></i> Granular Item Revisions</h4>';
                    ...
                    Object.entries(dataObj.item_changes).forEach(([itemId, changes]) => {
                        Object.entries(changes).forEach(([field, vals], fIdx) => {
                            html += `<tr>
                                ...
                                <td style="color: #059669; font-weight: 900; background: rgba(5, 150, 105, 0.05);">
