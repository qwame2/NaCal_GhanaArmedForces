...
<div class="animate-slide-up">
    ...
    <div class="glass-card" style="padding: 2rem; margin-bottom: 2rem; border-radius: 24px; background: #ffffff; border: 1px solid rgba(5, 150, 105, 0.1); box-shadow: 0 10px 30px rgba(0,0,0,0.02);">
        ...
        <form action="{{ route('admin.history') }}" method="GET" style="display: flex; gap: 1.5rem; align-items: flex-end; flex-wrap: wrap;">
            ...
            <div style="display: flex; gap: 1rem; align-items: center; margin-bottom: 3px;">
                <button type="submit" class="btn-primary" style="padding: 0.95rem 2rem; border-radius: 16px; border: none; background: var(--primary); color: white; font-weight: 800; cursor: pointer; transition: all 0.3s; box-shadow: 0 4px 12px rgba(5, 150, 105,0.2);">
                    Apply Filter
                </button>
    ...
    <!-- History Log Section -->
    @if($history->isEmpty())
        <div class="glass-card" style="padding: 4rem 2rem; text-align: center; border-radius: 24px; border: 1px dashed rgba(5, 150, 105, 0.2);">
            <div style="width: 64px; height: 64px; border-radius: 20px; background: rgba(5, 150, 105, 0.05); color: var(--primary); display: inline-flex; align-items: center; justify-content: center; margin-bottom: 1.5rem;">
        ...
        <div style="display: flex; flex-direction: column; gap: 1.5rem;">
            @foreach($history as $record)
                @if($record instanceof \App\Models\SystemLog)
                    ...
                    <div class="glass-card" style="padding: 1.5rem; border-radius: 20px; border: 1px solid rgba(5, 150, 105, 0.08); background: #ffffff; box-shadow: 0 4px 20px rgba(0,0,0,0.01); transition: all 0.3s;" onmouseover="this.style.transform='translateY(-2px)';" onmouseout="this.style.transform='translateY(0)';">
                        <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #f1f5f9; padding-bottom: 1rem; margin-bottom: 1rem; flex-wrap: wrap; gap: 1rem;">
                            ...
                            <div style="display: flex; align-items: center; gap: 0.75rem;">
                                <span style="display: inline-flex; align-items: center; gap: 0.4rem; padding: 0.35rem 0.75rem; border-radius: 20px; font-size: 0.75rem; font-weight: 800;
                                    ...
                                    @else
                                        background: #f0fdf4; color: #059669; border: 1px solid rgba(5, 150, 105, 0.15);
                                    @endif">
                ...
                @else
                    ...
                    <div class="glass-card" style="padding: 1.5rem; border-radius: 20px; border: 1px solid rgba(5, 150, 105, 0.08); background: #ffffff; box-shadow: 0 4px 20px rgba(0,0,0,0.01);">
                        <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #f1f5f9; padding-bottom: 1rem; margin-bottom: 1rem; flex-wrap: wrap; gap: 1rem;">
                            <div style="display: flex; align-items: center; gap: 1rem;">
                                <div style="width: 42px; height: 42px; border-radius: 12px; background: rgba(5, 150, 105, 0.05); color: var(--primary); display: flex; align-items: center; justify-content: center; font-weight: 900; font-size: 1rem;">
                                    #{{ $record->item_id }}
                                </div>
                                <div>
                            ...
                            <div style="display: flex; align-items: center; gap: 0.75rem;">
                                <span style="display: inline-flex; align-items: center; gap: 0.4rem; padding: 0.35rem 0.75rem; border-radius: 20px; font-size: 0.75rem; font-weight: 800; background: #eef2ff; color: var(--primary); border: 1px solid rgba(5, 150, 105, 0.15);">
                                            ...
                                            <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 0.9rem;">
                                                <thead>
                                                    <tr style="background: #f8fafc; border-bottom: 1px solid #edf2f7;">
                                                        ...
                                                        <th style="padding: 0.85rem 1.25rem; font-weight: 800; color: #059669; font-size: 0.75rem; text-transform: uppercase;">Modified Value</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                        ...
                                                        <table style="width: 100%; border-collapse: collapse; font-size: 0.85rem; background: white; border-radius: 12px; overflow: hidden; border: 1px solid #e2e8f0;">
                                                            <thead>
                                                                <tr style="background: #f8fafc; border-bottom: 1px solid #e2e8f0; text-align: left;">
                                                                    ...
                                                                    <th style="padding: 0.6rem 1rem; font-weight: 800; color: #059669; font-size: 0.7rem; text-transform: uppercase;">New Value</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
