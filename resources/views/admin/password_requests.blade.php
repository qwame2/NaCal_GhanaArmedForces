...
.rt-flash-close:hover { background: rgba(136, 19, 55, 0.1); opacity: 1; color: var(--primary); }
...
.rt-brand-icon {
    ...
    box-shadow: 0 8px 24px rgba(136, 19, 55, 0.35); flex-shrink: 0;
}
...
.rt-pending-badge {
    ...
    background: rgba(136, 19, 55, 0.1); color: var(--primary);
    border: 1px solid rgba(136, 19, 55, 0.2); padding: 3px 10px; border-radius: 999px;
    animation: pulse-badge 2s infinite;
}
@keyframes pulse-badge {
    0%, 100% { box-shadow: 0 0 0 0 rgba(136,19,55,0.3); }
    50% { box-shadow: 0 0 0 6px rgba(136,19,55,0); }
}
.rt-clear-badge {
    font-size: 0.6rem; font-weight: 900; letter-spacing: 0.12em;
...
@keyframes rt-live {
    0%, 100% { box-shadow: 0 0 0 0 rgba(136, 19, 55, 0.5); }
    50% { box-shadow: 0 0 0 5px rgba(136, 19, 55, 0); }
}
...
.rt-row-highlight td { background: rgba(136, 19, 55, 0.02); }
.rt-row-highlight:hover td { background: rgba(136, 19, 55, 0.05); }
...
.rt-callsign {
    ...
    background: rgba(136, 19, 55, 0.08); border: 1px solid rgba(136, 19, 55, 0.15);
...
.rt-status.active { background: rgba(136, 19, 55, 0.08); color: var(--primary); border: 1px solid rgba(136, 19, 55, 0.15); }
...
.rt-btn-approve {
    background: linear-gradient(135deg, var(--primary) 0%, #4c0519 100%);
    color: white; box-shadow: 0 4px 14px rgba(136, 19, 55, 0.25);
}
.rt-btn-approve:hover { transform: translateY(-2px); box-shadow: 0 8px 22px rgba(136, 19, 55, 0.35); }
.rt-btn-reject {
...
.rt-pagination-wrapper .page-item.active .page-link {
    background: #881337; color: white; border-color: #881337;
}
