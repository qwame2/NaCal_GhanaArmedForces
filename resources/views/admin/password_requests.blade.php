...
.rt-flash-close:hover { background: rgba(5, 150, 105, 0.1); opacity: 1; color: var(--primary); }
...
.rt-metric-glow { position: absolute; width: 120px; height: 120px; border-radius: 50%; right: -30px; top: -30px; opacity: 0.06; background: #0ea5e9; }
...
.rt-brand-icon {
    ...
    box-shadow: 0 8px 24px rgba(5, 150, 105, 0.35); flex-shrink: 0;
}
...
.rt-pending-badge {
    ...
    border: 1px solid rgba(14, 165, 233, 0.2); padding: 3px 10px; border-radius: 999px;
...
.rt-row-highlight td { background: rgba(14, 165, 233, 0.02); }
.rt-row-highlight:hover td { background: rgba(14, 165, 233, 0.05); }
...
.rt-status.active { background: rgba(14, 165, 233, 0.08); color: #0ea5e9; border: 1px solid rgba(5, 150, 105, 0.15); }
...
.rt-btn-approve {
    background: #059669;
    color: white; box-shadow: 0 4px 14px rgba(5, 150, 105, 0.25);
}
.rt-btn-approve:hover { transform: translateY(-2px); box-shadow: 0 8px 22px rgba(5, 150, 105, 0.35); }
.rt-btn-reject {
