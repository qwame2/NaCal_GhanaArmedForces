...
<div class="animate-slide-up">
    ...
    <div class="glass-card" style="padding: 0; overflow: hidden; border-radius: 24px;">
        <div style="padding: 1.5rem 2rem; background: rgba(5, 150, 105, 0.03); border-bottom: 1px solid var(--border-color); display: flex; align-items: center; justify-content: space-between;">
        ...
        <!-- Pagination Footer -->
        <div id="notifications-pagination" style="padding: 1.25rem 2rem; border-top: 1px solid var(--border-color); display: none; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; background: rgba(5, 150, 105, 0.01); border-radius: 0 0 24px 24px;">
