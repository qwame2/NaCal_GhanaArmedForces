...
<div class="animate-slide-up">
    ...
    <div class="glass-card" style="padding: 0; overflow: hidden; border-radius: 24px;">
        ...
        <!-- Pagination Footer -->
        <div id="notifications-pagination" style="padding: 1.25rem 2rem; border-top: 1px solid var(--border-color); display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; background: rgba(99, 102, 241, 0.01); border-radius: 0 0 24px 24px;">
    ...
    function applyFilter() {
        ...
        if (totalItems === 0) {
            ...
            if (navContainer) {
                ...
                // Prev button
                navHTML += `
                    <button onclick="goToPage(${currentPage - 1})" ${currentPage === 1 ? 'disabled' : ''} style="display: inline-flex; align-items: center; justify-content: center; width: 34px; height: 34px; border-radius: 8px; border: 1.5px solid var(--border-color); background: ${currentPage === 1 ? 'var(--bg-main)' : 'var(--bg-card)'}; color: ${currentPage === 1 ? 'var(--text-muted)' : 'var(--text-main)'}; cursor: ${currentPage === 1 ? 'not-allowed' : 'pointer'}; opacity: ${currentPage === 1 ? '0.5' : '1'}; transition: all 0.2s;" onmouseover="if(${currentPage !== 1}){this.style.borderColor='var(--primary)'; this.style.color='var(--primary)';}" onmouseout="this.style.borderColor='var(--border-color)'; this.style.color='var(--text-main)';">
                ...
                if (endPage < totalPages) {
                    ...
                    navHTML += `
                        <button onclick="goToPage(${totalPages})" style="display: inline-flex; align-items: center; justify-content: center; width: 34px; height: 34px; border-radius: 8px; border: 1.5px solid var(--border-color); background: var(--bg-card); color: var(--text-main); font-weight: 700; cursor: pointer; transition: all 0.2s;" onmouseover="this.style.borderColor='var(--primary)'; this.style.color='var(--primary)';" onmouseout="this.style.borderColor='var(--border-color)'; this.style.color='var(--text-main)';">${totalPages}</button>
                    `;
                }

                // Next button
                navHTML += `
                    <button onclick="goToPage(${currentPage + 1})" ${currentPage === totalPages ? 'disabled' : ''} style="display: inline-flex; align-items: center; justify-content: center; width: 34px; height: 34px; border-radius: 8px; border: 1.5px solid var(--border-color); background: ${currentPage === totalPages ? 'var(--bg-main)' : 'var(--bg-card)'}; color: ${currentPage === totalPages ? 'var(--text-muted)' : 'var(--text-main)'}; cursor: ${currentPage === totalPages ? 'not-allowed' : 'pointer'}; opacity: ${currentPage === totalPages ? '0.5' : '1'}; transition: all 0.2s;" onmouseover="if(${currentPage !== totalPages}){this.style.borderColor='var(--primary)'; this.style.color='var(--primary)';}" onmouseout="this.style.borderColor='var(--border-color)'; this.style.color='var(--text-main)';">
