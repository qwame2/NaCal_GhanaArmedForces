    ...
    <div class="glass-card print-table-wrapper unified-ledger-card rpt-log-card" style="border-radius: 24px; border: 1px solid var(--border-color); overflow: hidden;">
        ...
        <div id="table-container" class="custom-scroll table-responsive" style="overflow-x: auto; {{ $allTransactions->count() > 0 ? '' : 'display: none;' }}">
            <table class="formal-table unified-table rpt-unified-table" style="width: 100%; min-width: 900px;">
                <thead>
                    <tr>
                        <th style="width: 10%; padding-left: 1.5rem;">Date</th>
                        ...
                        <th style="text-align:right; width: 10%; padding-right: 1.5rem;">Variance</th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        <td data-label="Type" style="text-align:center;">
                            <div style="display: flex; flex-direction: column; align-items: center; gap: 4px;">
                                ...
                                @else
                                    ...
                                    @else
                                        <span style="font-size: 0.65rem; font-weight: 800; color: #dc2626; background: rgba(220,38,38,0.08); padding: 1px 6px; border-radius: 4px; border: 1px solid rgba(220,38,38,0.2); text-transform: uppercase;">
                                            Permanent
                                        </span>
                                    @endif
                                @endif
...
<style>
    ...
    @media print {
        ...
        * { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
        ...
        .ledger-row-issued   td { background: #ecfdf5 !important; }
