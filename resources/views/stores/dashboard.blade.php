...
<div class="animate-slide-up">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1.25rem; margin-bottom: 2rem;">
        ...
        <div class="stat-card" style="background: var(--bg-card); border-radius: 18px; padding: 1.5rem; border: 1px solid var(--border-color); position: relative; overflow: hidden; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(0,0,0,0.02);">
            ...
            <h3 style="font-size: 2.25rem; font-weight: 900; color: var(--text-main); margin: 0 0 0.5rem 0; letter-spacing: -0.03em;">{{ number_format($pendingItemEntryCount) }}</h3>
        ...
        <div class="stat-card" style="background: var(--bg-card); border-radius: 18px; padding: 1.5rem; border: 1px solid var(--border-color); position: relative; overflow: hidden; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(0,0,0,0.02);">
            ...
            <h3 style="font-size: 2.25rem; font-weight: 900; color: var(--text-main); margin: 0 0 0.5rem 0; letter-spacing: -0.03em;">{{ number_format($pendingServiceSraCount) }}</h3>
        ...
        <div class="stat-card" style="background: var(--bg-card); border-radius: 18px; padding: 1.5rem; border: 1px solid var(--border-color); position: relative; overflow: hidden; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(0,0,0,0.02);">
            ...
            <h3 style="font-size: 2.25rem; font-weight: 900; color: var(--text-main); margin: 0 0 0.5rem 0; letter-spacing: -0.03em;">{{ number_format($lowStockCount) }}</h3>
    ...
    <div style="margin-bottom: 2rem;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1rem;">
            ...
            <a href="{{ route('admin.inventory') }}" style="background: var(--bg-card); padding: 1.25rem; border-radius: 16px; border: 1px solid var(--border-color); text-decoration: none; color: var(--text-main); display: flex; align-items: center; gap: 1rem; transition: all 0.2s ease; box-shadow: 0 2px 8px rgba(0,0,0,0.02);">
                <div style="width: 42px; height: 42px; border-radius: 12px; background: rgba(139, 92, 246, 0.1); color: #8b5cf6; display: flex; align-items: center; justify-content: center; shrink: 0;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(400px, 1fr)); gap: 1.5rem;">
        ...
        <div style="background: var(--bg-card); border-radius: 18px; border: 1px solid var(--border-color); padding: 1.5rem; box-shadow: 0 4px 15px rgba(0,0,0,0.02);">
                    ...
                    <table style="width: 100%; border-collapse: collapse; font-size: 0.85rem;">
                        ...
                        <tbody>
                            ...
                            <tr style="border-bottom: 1px solid var(--border-color);">
                                ...
                                <td style="padding: 0.85rem 0.5rem; text-align: right;">
                                    <a href="{{ route('stores.item-entry-approval') }}" style="background: rgba(59, 130, 246, 0.1); color: #3b82f6; padding: 0.35rem 0.75rem; border-radius: 8px; font-weight: 800; font-size: 0.75rem; text-decoration: none;">
                                        Authorize
                                    </a>
                                </td>
                            </tr>
