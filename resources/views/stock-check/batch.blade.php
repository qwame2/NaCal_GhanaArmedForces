    ...
    <div class="page-header" style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 2rem; flex-wrap: wrap; gap: 1.5rem;">
        <div>
            <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 0.5rem;">
                <span style="background: rgba(99, 102, 241, 0.1); color: #6366f1; font-size: 0.7rem; font-weight: 800; padding: 0.25rem 0.75rem; border-radius: 9999px; text-transform: uppercase;">Logistics Audit</span>
            </div>
    ...
    <div class="glass-card" style="padding: 2rem; border-radius: 28px; background: var(--bg-card); border: 1px solid var(--border-color); box-shadow: 0 25px 50px -12px rgba(0,0,0,0.15); margin-bottom: 2rem;">
        <form id="batchVerifyForm" onsubmit="event.preventDefault(); submitBatchStockCheck();" style="display: flex; flex-direction: column; gap: 1.5rem;">
                    ...
                    <tbody id="batchVerifyTableBody">
                        ...
                        <tr class="batch-verify-row" data-desc="{{ $item->description }}" style="border-bottom: 1px solid var(--border-color);">
                            ...
                            <td style="padding: 1.25rem 1rem; vertical-align: middle;">
                                @if($onLoanCount > 0)
                                    <span style="font-size: 0.75rem; font-weight: 800; color: #f59e0b; background: rgba(245, 158, 11, 0.1); padding: 0.25rem 0.6rem; border-radius: 6px; border: 1px solid rgba(245, 158, 11, 0.2);">
            ...
            <div id="batchLoansContainer" style="margin-top: 1rem;">
                <h4 style="font-size: 1.1rem; font-weight: 800; color: #f59e0b; margin-bottom: 0.75rem; display: flex; align-items: center; gap: 6px;">
                ...
                <div style="overflow-x: auto; max-height: 350px; border-radius: 12px; border: 1px solid var(--border-color); background: var(--bg-main); margin-bottom: 1.5rem;">
                    <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 0.82rem;">
                        <thead>
                            <tr style="background: rgba(245, 158, 11, 0.05); border-bottom: 1.5px solid var(--border-color); height: 40px;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-top: 1rem;">
                ...
                <button type="button" onclick="generateBatchVerificationReport()" class="btn-primary" style="width: 100%; padding: 1.1rem; border-radius: 18px; border: none; background: linear-gradient(135deg, #6366f1 0%, #4f46e5 100%) !important; color: white !important; font-weight: 900 !important; font-size: 1.05rem; cursor: pointer; box-shadow: 0 10px 20px rgba(99, 102, 241, 0.2); display: flex; align-items: center; justify-content: center; gap: 8px;">
