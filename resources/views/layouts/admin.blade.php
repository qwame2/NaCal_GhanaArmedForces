    ...
    <aside class="sidebar" id="sidebar">
        ...
        <div class="nav-scroller">
            ...
            <ul class="nav-list">
                ...
                @if($isSraStoresHead)
                <li>
                    <a href="{{ route('stores.dashboard') }}" class="nav-link {{ request()->routeIs('stores.dashboard') ? 'active' : '' }}" title="Stores Dashboard">
                ...
                <li>
                    <a href="{{ route('stores.sra-vault') }}" class="nav-link {{ request()->routeIs('stores.sra-vault') ? 'active' : '' }}" title="Approved SRA Vault">
