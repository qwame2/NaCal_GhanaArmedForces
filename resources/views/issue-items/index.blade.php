...
<div class="animate-slide-up" style="max-width: 1600px; margin: 0 auto; padding: 0 1.5rem;">
    ...
    <div class="glass-card header-mesh" style="padding: 3rem; border-radius: 32px; margin-bottom: 3rem; position: relative; overflow: hidden; border: 1px solid rgba(255,255,255,0.4); box-shadow: 0 25px 50px -12px rgba(0,0,0,0.08);">
        <div style="position: absolute; top: -100px; right: -100px; width: 300px; height: 300px; background: transparent; z-index: 0;"></div>
        <div style="position: absolute; bottom: -50px; left: -50px; width: 200px; height: 200px; background: transparent; z-index: 0;"></div>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 2rem; margin-bottom: 3rem;">
        ...
        <div class="glass-card stat-card" style="padding: 2rem; border-radius: 24px; border: 1px solid var(--border-color); display: flex; align-items: center; gap: 1.5rem; transition: transform 0.3s;">
            <div style="width: 64px; height: 64px; border-radius: 20px; background: rgba(139, 92, 246, 0.1); color: #047857; display: flex; align-items: center; justify-content: center;">
                        ...
                        <tr class="activity-row" data-date="{{ $dateVal }}" data-category="{{ $item->ledge_category }}" data-type="{{ $item->issuance_type }}" data-search="{{ strtolower($item->description . ' ' . $item->beneficiary . ' ' . ($item->authority ?? 'Adomako Emmanuel') . ' ' . ($item->collector_name ?? '') . ' ' . ($item->confirming_officer_name ?? 'Adomako Emmanuel')) }}" style="border-top: 1px solid var(--border-color);">
                            ...
                            <td data-label="Items" style="padding: 1.25rem 1.5rem;">
                                ...
                                <div style="margin-top: 4px;">
                                    <span style="font-size: 0.65rem; background: rgba(5, 150, 105, 0.1); color: var(--primary); padding: 0.2rem 0.5rem; border-radius: 6px; font-weight: 600; text-transform: uppercase;">
...
<style>
    .inventory-badge {
        ...
        letter-spacing: 0.1em; box-shadow: 0 5px 15px rgba(5, 150, 105, 0.3);
    }
    .gradient-text {
        color: var(--primary);
    }
