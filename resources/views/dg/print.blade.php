...
<head>
    ...
    <title>Director General Oversight & Command Ledger - NACOC Central Store</title>
    <style>
        body {
...
<body onload="window.print();">
    ...
    <div class="meta-grid">
        <div>
            ...
            <div class="meta-item"><span>Department:</span> {{ $dg->department ?? 'Office of the Director General' }}</div>
    ...
    <div class="report-generation-footer" style="margin-top: 40px; padding: 16px 20px; background: #f8fafc; border: 1.5px solid #cbd5e1; border-radius: 6px; page-break-inside: avoid;">
        <div style="display: flex; justify-content: space-between; align-items: center; font-size: 11px; color: #334155;">
            <div>
                ...
                <span style="color: #64748b; margin-left: 6px; font-weight: 600;">({{ $dg->role }}{{ $dg->department ? ' &bull; ' . $dg->department : '' }})</span>
            </div>
            <div style="text-align: right;">
