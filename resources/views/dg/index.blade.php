            ...
            <div class="cfg-card-header" style="background: #f8fafc; padding: 2.25rem 2.5rem; display: flex; align-items: center; justify-content: space-between; border-bottom: 1px solid #f1f5f9; flex-wrap: wrap; gap: 1rem;">
                <div style="display: flex; align-items: center; gap: 1.25rem;">
                    ...
                    <div>
                        ...
                        <p style="color: #64748b; font-weight: 600; font-size: 0.82rem; margin: 4px 0 0;">Select specific item categories and/or individual items that require intermediate review and sign-off by you (Director General).</p>
                    </div>
                </div>
