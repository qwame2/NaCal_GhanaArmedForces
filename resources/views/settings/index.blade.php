    ...
    <div class="glass-card header-mesh" style="padding: 2.5rem 3rem; border-radius: 32px; margin-bottom: 2.5rem; position: relative; overflow: hidden; border: 1px solid rgba(255,255,255,0.4); box-shadow: 0 25px 50px -12px rgba(0,0,0,0.08);">
        ...
        <div style="position: relative; z-index: 1; display: flex; align-items: center; gap: 2.5rem;">
            <div style="position: relative;" id="avatar-preview-container">
                ...
                @else
                    <div id="user-avatar-placeholder" style="width: 110px; height: 110px; background: var(--primary); border-radius: 28px; display: flex; align-items: center; justify-content: center; font-size: 2.5rem; font-weight: 950; color: white; box-shadow: 0 15px 35px var(--primary-glow); border: 4px solid white;">
            ...
            <div>
                <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 0.5rem;">
                    <span style="background: var(--primary-glow); color: var(--primary); font-size: 0.65rem; font-weight: 950; padding: 0.35rem 1rem; border-radius: 99px; text-transform: uppercase; letter-spacing: 0.1em;">Authenticated Personnel</span>
                    <span style="color: var(--text-muted); font-size: 0.85rem; font-weight: 700; display: flex; align-items: center; gap: 6px;">
                        <i data-lucide="shield-check" style="width: 14px; color: var(--primary);"></i> Security Verified
                    </span>
                </div>
    ...
    <div style="display: grid; grid-template-columns: 320px 1fr; gap: 2.5rem; align-items: flex-start; padding-bottom: 5rem;" class="settings-grid">
        ...
        <div id="settingsContent" class="glass-card" style="padding: 3.5rem; border-radius: 32px; min-height: 600px;">
            ...
            <div id="section-profile" class="settings-section active">
                ...
                <div style="background: var(--primary-glow); padding: 2rem; border-radius: 20px; border: 1px solid var(--primary-glow);">
...
<style>
    ...
    .setting-item:hover { border-color: #0ea5e9; background: var(--primary-glow); }
    ...
    .save-btn {
        ...
        transition: all 0.4s; box-shadow: 0 12px 30px var(--primary-glow);
    }
    .save-btn:hover { background: var(--primary-dark); transform: translateY(-3px); box-shadow: 0 18px 40px var(--primary-glow); }
...
<script>
    ...
    function validatePassword() {
        ...
        if (pass.length > 0) {
            ...
            else if (strength <= 50) strengthBar.style.background = 'var(--primary)';
            else if (strength <= 75) strengthBar.style.background = 'var(--primary)';
            else strengthBar.style.background = 'var(--primary)';
        } else {
        ...
        if (confirm.length > 0) {
            ...
            if (pass === confirm) {
                ...
                matchTag.style.color = 'var(--primary)';
            } else {
