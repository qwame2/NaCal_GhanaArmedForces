                        ...
                        <tbody>
                            ...
                            <tr class="sra-table-row" style="cursor: pointer;" onclick="window.open('{{ route('stores.service-sra.review', $sra->id) }}', '_blank')">
                                ...
                                <td style="padding: 1rem 1.5rem; text-align: center;">
                                    <a href="{{ route('stores.service-sra.review', $sra->id) }}" target="_blank" onclick="event.stopPropagation();" style="background: rgba(16,185,129,0.08); color: #10b981; border: 1px solid rgba(16,185,129,0.2); border-radius: 10px; padding: 0.5rem 1rem; font-size: 0.78rem; font-weight: 800; text-decoration: none; display: inline-flex; align-items: center; gap: 5px;">
