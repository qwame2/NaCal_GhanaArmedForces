...
<div class="animate-slide-up">
    ...
    <div class="page-header" style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 2rem; flex-wrap: wrap; gap: 1rem;">
        ...
        <a href="{{ route('service-sra.create') }}" class="btn-primary" style="padding: 0.85rem 1.75rem; border: none; border-radius: 14px; cursor: pointer; background: #059669; color: white; font-weight: 800; display: flex; align-items: center; gap: 0.5rem; text-decoration: none; box-shadow: 0 8px 20px -5px rgba(5,150,105,0.4);">
        ...
        <form method="GET" class="filter-row" id="sra-filter-form" action="{{ route('service-sra.index') }}">
            ...
            <div class="filter-field-wrapper" style="min-width: 180px; flex: 1;">
                ...
                <select name="status" onchange="updateSraFilters()" class="filter-control">
                    ...
                    <option value="pending" {{ request('status')==='pending'?'selected':'' }}>Awaiting Authorizer Review</option>
