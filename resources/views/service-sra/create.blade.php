...
<div class="animate-slide-up">
    ...
    <div class="page-header sra-header-section" style="display: flex; justify-content: space-between; align-items: flex-end; flex-wrap: wrap; gap: 1rem;">
        <div>
            <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 0.5rem;">
                <span style="background: rgba(136,19,55,0.1); color: var(--primary); font-size: 0.7rem; font-weight: 800; padding: 0.25rem 0.75rem; border-radius: 9999px; text-transform: uppercase; letter-spacing: 0.05em;">Stores Division</span>
            </div>
    ...
    <div class="sra-form-card">
        <form id="sraForm" novalidate>
            ...
            <div id="previousSraGroup" style="display: none; margin-bottom: 1.5rem; background: rgba(136,19,55,0.06); border: 1px dashed rgba(136,19,55,0.4); border-radius: 14px; padding: 1.25rem;">
                <label class="sra-field-label" for="previous_sra_nos">
                    <i data-lucide="link" style="width: 13px; color: #881337;"></i>
