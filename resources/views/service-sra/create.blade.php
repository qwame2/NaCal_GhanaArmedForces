...
<div class="animate-slide-up">
    ...
    <div class="page-header sra-header-section" style="display: flex; justify-content: space-between; align-items: flex-end; flex-wrap: wrap; gap: 1rem;">
        <div>
            <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 0.5rem;">
                <span style="background: rgba(5,150,105,0.1); color: var(--primary); font-size: 0.7rem; font-weight: 800; padding: 0.25rem 0.75rem; border-radius: 9999px; text-transform: uppercase; letter-spacing: 0.05em;">Stores Division</span>
            </div>
    ...
    <div class="sra-form-card">
        <form id="sraForm" novalidate>
            ...
            <div id="previousSraGroup" style="display: none; margin-bottom: 1.5rem; background: rgba(5,150,105,0.06); border: 1px dashed rgba(5,150,105,0.4); border-radius: 14px; padding: 1.25rem;">
                <label class="sra-field-label" for="previous_sra_nos">
                    <i data-lucide="link" style="width: 13px; color: #059669;"></i>
            ...
            <div style="border-top: 1px solid var(--border-color); padding-top: 1.5rem; display: flex; justify-content: flex-end; gap: 1rem; flex-wrap: wrap; align-items: center;">
                ...
                <button type="submit" id="sraSubmitBtn" class="btn-primary" style="padding: 1rem 3rem; border: none; border-radius: 14px; cursor: pointer; background: #059669; color: white; font-weight: 800; font-size: 1rem; display: flex; align-items: center; gap: 0.75rem; box-shadow: 0 10px 25px -5px rgba(5,150,105,0.4);">
