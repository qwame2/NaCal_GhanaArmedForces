    ...
    <div class="document-wrapper">
        <div class="sra-container">
            ...
            @php
                ...
                $auditorUser = is_numeric($sra->auditor_approved_by) ? \App\Models\User::find($sra->auditor_approved_by) : \App\Models\User::where('name', $sra->auditor_approved_by)->first();
            @endphp
                ...
                <div class="sig-cell">
                    ...
                    <div>
                        ...
                        <div class="sig-name-date">
                            ...
                            <div><strong>Role:</strong> 
                                @if($auditorUser)
                                    {{ ($auditorUser->role === 'Sub Main Admin' || $auditorUser->role === 'Main Admin') ? ('Head of ' . preg_replace('/\s+department$/i', '', trim($auditorUser->department ?: 'Internal Audit')) . ' (Delegator Authorizer)') : ($auditorUser->role ?? 'Auditor') }}
                                @else
